<template>
	<view class="me-root">
		<navigator class="me-user-wrapper" url="../userInfo/userInfo">
			<!-- 头像 -->
			<image class="me-user-avatar" mode="aspectFill"
				src="https://tvax1.sinaimg.cn/crop.0.0.1002.1002.180/644c31cbly8fus4o17o9wj20ru0rutbb.jpg?KID=imgbed,tva&Expires=1590514391&ssig=k4anARnCHE">
			</image>
