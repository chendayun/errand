<template>
	<view class="feedback-root">
		...
		<view class="feedback-content-wrapper common-padding feedback-item-margin-top">
			...
			<textarea class="feedback-content" v-model="content" required
				placeholder-class="feedback-content-placeholder" value="" placeholder="我们将不断为您改进" />
		</view>
		...
		<view class="feedback-other-wrapper common-padding feedback-item-margin-top">
			...
			<input v-model="contactInfo" placeholder-class="feedback-content-placeholder" type="text" value=""
				placeholder="您的联系方式" />
		</view>
